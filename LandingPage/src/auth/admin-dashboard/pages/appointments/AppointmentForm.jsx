                                ...
                                <div className="space-y-4">
                                    ...
                                    <div className="grid grid-cols-2 sm:grid-cols-3 gap-2">
                                        {['09:00 AM', '09:30 AM', '10:00 AM', '10:30 AM', '11:00 AM', '11:30 AM', '12:00 PM', '12:30 PM', '02:00 PM', '02:30 PM', '03:00 PM', '03:30 PM', '04:00 PM', '04:30 PM'].map(t => (
                                            <button key={t} type="button" onClick={() => update('time', t)} className={`px-3 py-2 rounded-md border text-sm ${(form.time) === t ? 'bg-sky-600 text-white border-sky-700' : 'bg-white text-sky-900 border-sky-200 hover:bg-sky-50'}`}>{t}</button>
                                        ))}
                                    </div>
                                    <div className="flex items-center justify-between pt-2">
                                ...
                                <div className="space-y-4">
                                    ...
                                    <div className="flex items-center justify-between pt-2">
                                        ...
                                        <div className="flex items-center gap-2">
                                            <button type="button" onClick={async () => { await onSubmit(new Event('submit')); closeModal() }} disabled={!form.patientName || !form.date || !form.time || !form.doctor} className={`px-4 py-2 rounded-lg font-bold ${form.patientName && form.date && form.time && form.doctor ? 'bg-sky-600 hover:bg-sky-700 text-white' : 'bg-sky-300 text-white cursor-not-allowed'}`}>Save</button>
