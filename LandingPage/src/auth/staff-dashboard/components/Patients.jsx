...
const Patients = ({ appointments = [], onPatientSelect, selectedDate, onDateChange, onDelete }) => {
  ...
  // Group appointments by date, but since we select a single date, it's just a list
  // If we wanted to group by Doctor, we could do that, but just listing is fine for now as per Doctor Dashboard
